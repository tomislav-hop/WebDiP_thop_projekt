$(document).ready(function() {
    $(function() {
        ...
        tablica.append('<thead><tr><th>Naziv</th><th>Broj artefakata</th></tr></thead>');

        $.get('http://arka.foi.hr/WebDiP/2013_projekti/WebDiP2013_023/data/stat2.xml', function(xml) {
            var tbody = $("<tbody>");
